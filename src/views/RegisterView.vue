...
const subline = computed(() => {
  if (step.value === 0) {
    return 'Імʼя власника акаунта — його видно в меню та налаштуваннях.'
  }

  return step.value === 1
    ? 'Пошта стане логіном. Телефон — для звʼязку з вами.'
    : 'Пароль від 8 символів. Далі створите робочий простір для своїх обʼєктів.'
})
