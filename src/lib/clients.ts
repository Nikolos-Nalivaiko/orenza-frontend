 ...
 * працюють у картці обʼєкта (lib/finance). Сенс модуля в іншому: звести все,
 * що розкидано по обʼєктах однієї людини, в одну відповідь на питання
 * «скільки їх у неї, скільки вона винна разом і чи вигідна вона нам загалом».
 *
